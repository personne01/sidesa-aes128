...
<head>
  ...
  <title>
    Tailwind Starter Template - Minimal Admin Template: Tailwind Toolbox
  </title>
      ...
      <nav id="header1" class="
        ...
        <div class="flex h-full justify-between items-center">
          ...
          <div class="relative w-full max-w-3xl px-6">
            ...
            <input id="search-toggle" type="search" placeholder="search" class="
                  block
                  w-full
                  bg-gray-200
                  focus:outline-none focus:bg-white focus:shadow-md
        ...
        <div class="
          ...
          <div class="flex flex-col items-center">
            ...
            <div class="flex-1">
              <h3 class="font-bold text-3xl">
                249
                <span class="text-orange-500"><i class="fas fa-exchange-alt"></i></span>
              </h3>
